                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="m-t-15">
                                ...
                                <a href=<?php echo e(route('presensi')); ?>><button class="btn btn-dark m-r-10" type="button"
                                        title="">Back</button></a>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/redtech/development/website/Laravel/cuba_starter_kit/resources/views/admin/presensi/detail.blade.php ENDPATH**/ ?>