...
<div class="container-fluid">
         <div class="row">
                  <div class="col-sm-12">
                           <div class="card">
                                    <div class="card-body">
                                             <form novalidate="" method="POST" action="<?php echo e(route('store-karyawan')); ?>">
                                                      <?php echo csrf_field(); ?>
                                                      <div class="row">
...
unset($__errorArgs, $__bag); ?>" id="validationCustom01" type="text" name="fullName" placeholder="Full Name" required="" value="<?php echo e(old('fullName')); ?>" name="fullName">
...
unset($__errorArgs, $__bag); ?>" id="validationCustom02" type="number" placeholder="NIP" name="nip" value="<?php echo e(old('nip')); ?>" required="">
...
unset($__errorArgs, $__bag); ?>" id="jabatan_select" name="jabatan">
                                                                                 ...
                                                                                 <option value="<?php echo e($item->id); ?>" <?php echo e(old('jabatan') == $item->id ? 'selected' : ''); ?>><?php echo e($item->jabatan); ?></option>
...
unset($__errorArgs, $__bag); ?>" id="validationCustom01" type="email" placeholder="Email" name="email" required="" value="<?php echo e(old('email')); ?>">
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/redtech/development/website/Laravel/cuba_starter_kit/resources/views/admin/karyawan/add.blade.php ENDPATH**/ ?>