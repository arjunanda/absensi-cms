                ...
                <div class="px-2 py-2">
                    <table>
                        <tr>
                            ...
                            <td class="text-dark" style="font-size: 14px;"><?php echo e($user->name); ?></td>
                        </tr>
                        <tr>
                            <td><b style="font-size: 14px;" class="text-dark">Jabatan</b></td>
                            <td class="px-3 text-dark" style="font-size: 14px;">:</td>
                            <td class="text-dark" style="font-size: 14px;"><?php echo e($user->jabatans->jabatan); ?></td>
                        </tr>
                    </table>
                </div>
                <div class="mt-2 d-flex justify-content-evenly flex-row">
                    <button type="button" class="btn btn-success <?php echo e(!$absensi ? 'active' : ''); ?> disabled"
                        id="MasukButton">Masuk</button>
                    <button type="button" class="btn btn-danger <?php echo e(@@$absensi->check_in ? 'active' : ''); ?> disabled"
...
<?php echo $__env->make('karyawan.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/redtech/development/website/Laravel/cuba_starter_kit/resources/views/karyawan/absen/rekam-kehadiran.blade.php ENDPATH**/ ?>