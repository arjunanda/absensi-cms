            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form novalidate="" method="POST" action="<?php echo e(route('update_profile')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        required="" value="<?php echo e(old('fullName') ?? $user->name); ?>" name="fullName">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control" id="validationCustom02" type="file" name="image" placeholder="Image"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="pt-3">
                                        <img src="<?php echo e(@$user->image ? '/uploads/' . @$user->image : '/assets/img/profile.png'); ?>" id="imagePreview" alt="" width="100" height="100"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <a href="<?php echo e(route('karyawan')); ?>"><button class="btn btn-secondary"
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/redtech/development/website/Laravel/cuba_starter_kit/resources/views/admin/settings/update_profile.blade.php ENDPATH**/ ?>