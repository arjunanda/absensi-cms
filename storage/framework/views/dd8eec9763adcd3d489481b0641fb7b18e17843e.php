                  ...
                  <nav class="sidebar-main">
                           ...
                           <div id="sidebar-menu">
                                    <ul class="sidebar-links" id="simple-bar">
                                             ...
                                             <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav <?php echo e((Route::currentRouteName()=='settings') ? 'active' : ''); ?>" href="<?php echo e(route('settings')); ?>"><i data-feather="settings"> </i><span>Setting</span></a></li>
