            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form novalidate="" method="POST" action="{{ route('update_profile') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="pt-3">
                                        <img src="{{@$user->image ? '/uploads/' . @$user->image : '/assets/img/profile.png'}}" id="imagePreview" alt="" width="100" height="100"
                            ...
                            <a href="{{ route('karyawan') }}"><button class="btn btn-secondary"
