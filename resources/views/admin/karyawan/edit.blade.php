    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form novalidate="" method="POST" action="{{ route('update-karyawan', ['id' => $user->id]) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control @error('jabatan') is-invalid @enderror" id="jabatan_select"
                                        name="jabatan">

                                        <option value="0">--Select--</option>
                                        @foreach ($jabatan as $item)
                                            <option value="{{ $item->id }}"
                                                {{ (old('jabatan') ?? $user->jabatan_id) == $item->id ? 'selected' : '' }}>
                                                {{ $item->jabatan }}</option>
                                        @endforeach
                                    </select>
                                    @error('jabatan')
