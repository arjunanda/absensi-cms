...
<div class="container-fluid">
         <div class="row">
                  <div class="col-sm-12">
                           <div class="card">
                                    <div class="card-body">
                                             <form novalidate="" method="POST" action="{{ route('store-karyawan') }}">
                                                      @csrf
                                                      <div class="row">
                                                               <div class="col-md-6 mb-3">
                                                                        <label for="validationCustom01">Full Name</label>
                                                                        <input class="form-control @error('fullName') is-invalid @enderror" id="validationCustom01" type="text" name="fullName" placeholder="Full Name" required="" value="{{ old('fullName') }}" name="fullName">
                                                               ...
                                                               <div class="col-md-6 mb-3">
                                                                        ...
                                                                        <input class="form-control @error('nip') is-invalid @enderror" id="validationCustom02" type="number" placeholder="NIP" name="nip" value="{{ old('nip') }}" required="">
                                                               ...
                                                               <div class="col-md-6 mb-3">
                                                                        ...
                                                                        <input class="form-control @error('email') is-invalid @enderror" id="validationCustom01" type="email" placeholder="Email" name="email" required="" value="{{ old('email') }}">
