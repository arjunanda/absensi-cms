                           ...
                           <form novalidate="" method="POST" action="{{ route('store_lembur') }}" enctype="multipart/form-data">
                                ...
                                value="{{ old('start_date') }}" autocomplete="off"> --}}
                                                      ...
                                                      <div class="input-group clockpicker pull-center" data-placement="bottom" data-align="left" data-autoclose="true">
                                                               <input class="form-control @error('start_date') is-invalid @enderror" id="validationCustom01" type="text" name="start_date" value="{{ old('start_date') }}" autocomplete="off"><span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                                               @error('start_date')
                                             ...
                                             <div class="col-md-12 mb-3">
                                                      ...
                                                      <div class="input-group clockpicker pull-center" data-placement="bottom" data-align="left" data-autoclose="true">
                                                               <input class="form-control @error('end_date') is-invalid @enderror" type="text" name="end_date" value="{{ old('end_date') }}" autocomplete="off"><span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                                               @error('end_date')
                                                               <div class="invalid-feedback">{{ $message }}</div>
                                                               @enderror
                                                      </div>
                                             ...
                                             <div class="col-md-12 mb-3">
                                                      ...
                                                      <div class="input-group">
                                                               ...
                                                               <textarea class="form-control @error('alasan') is-invalid @enderror" id="validationCustom01" type="text" placeholder="Alasan Lembur" name="alasan" required="" value="{{ old('alasan') }}" rows="5"></textarea>
