                           ...
                           <div>
                                    ...
                                    <div class="d-flex justify-content-evenly align-items-center mt-4 bg-light rounded" style="height:100px">
                                             <div class="text-center">
                                                      <img src="{{ asset('assets/svg-icon/bookmart.svg') }}" alt="" style="width:50px; height:50px;">
                                                      <p class="text-dark">Permohonan izin</p>
                                             </div>
                                             <div class="text-center">
                                                      <img src="{{ asset('assets/svg-icon/date-svgrepo-com.svg') }}" alt="" style="width:50px; height:50px;">
                                                      <p class="text-dark">History Kehadiran</p>
                                             </div>
                                             <div class="text-center">
                                                      <img src="{{ asset('assets/svg-icon/time-svgrepo-com.svg') }}" alt="" style="width:50px; height:50px;">
