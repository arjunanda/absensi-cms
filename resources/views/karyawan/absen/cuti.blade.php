    ...
    <div class="position-fixed  border-top border-1 p-0" style="max-width: 500px;">
        <div>
            ...
            <div class="px-3 py-3">
                ...
                <form novalidate="" action="{{ route('store_permohonan') }}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <select class="form-control @error('type_izin') is-invalid @enderror" id="type" name="type_izin">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('alasan') is-invalid @enderror" id="validationCustom03" type="text"
                                placeholder="Alasan" name="alasan" required="" value="{{ old('alasan') }}" rows="5"></textarea>
