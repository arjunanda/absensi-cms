                  ...
                  <nav class="sidebar-main">
                           ...
                           <div id="sidebar-menu">
                                    <ul class="sidebar-links" id="simple-bar">
                                            ...
                                            @else
                                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='dashboard.owner' ? 'active' : '' }}" href="{{route('dashboard.owner')}}"><i data-feather="home"> </i><span>{{ trans('lang.Dashboards') }}</span></a></li>
